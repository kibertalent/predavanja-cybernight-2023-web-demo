                    ...
                    <tbody>
                        <?php foreach ($subject_grades as $grade) : ?>
                            <tr>
                                ...
                                <?php
                                $urlencoded_return = urlencode("/admin/user.php?id=$user_id");
                                ?>
                                <td><a href="/teacher/delete_grade.php?grade_id=<?php echo $grade['id']; ?>&return_to=<?php echo $urlencoded_return; ?>" class="btn btn-danger">Izbriši</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
